...
public struct SearchNotesTransaction: GRDBTransaction {
    ...
    public func execute(_ connection: Connection) async throws -> Result {
        try QueryFeature.search(query: parameter.query, axis: parameter.axis, limit: parameter.limit, expand: parameter.expand, cliSessionId: parameter.cliSessionId, includeStale: parameter.includeStale, excludeAxes: parameter.excludeAxes, raw: parameter.raw)
    }
}
