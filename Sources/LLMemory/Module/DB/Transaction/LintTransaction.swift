...
public struct LintTransaction: LegacyReadTransaction {
    // MARK: - Property
    ...
    public func execute(_ connection: Connection) async throws -> Result {
        try Retrieval.lint(connection, id: parameter.id, code: parameter.code, severity: parameter.severity, limit: parameter.limit, includeDismissed: parameter.includeDismissed)
    }
}
