...
// integrity check. These conform to the store's operation protocol but
...
struct ReconcileIndexOperation: GRDBOperation {
    // MARK: - Property
    ...
    // MARK: - Public
    func execute(_ db: Database) throws -> Indexer.BuildResult {
