...
struct SeedTests {
    ...
    private var seeding: Seeding { Seeding(paths: home.paths) }
    ...
    func initPlantsSeedsAsRetrievableNotes() throws {
        ...
        for seed in Seed.notes {
            // When
            let planted = brain.file(home.paths.relativeFile(forId: seed.id))
    ...
    func updateRestatesAnEditedSeedNote() throws {
        ...
        let file = brain.file(home.paths.relativeFile(forId: seed.id))
    ...
    func theSeedMarkIsProjected() throws {
        ...
        for seed in Seed.notes {
            try home.reindexFile(at: home.paths.file(forId: seed.id))
        }
    ...
    func aConflictLeavesEverySeedUnplanted() throws {
        ...
        for other in Seed.notes where other.id != seed.id {
            #expect(!FileManager.default.fileExists(
                atPath: brain.file(home.paths.relativeFile(forId: other.id)).path
    ...
    func aRetiredSeedIsTrashedAndReported() throws {
        ...
        let retired = brain.file(home.paths.relativeFile(forId: "innate.gone"))
    ...
    func retirementIsConfirmedAgainstTheFile() throws {
        ...
        let file = brain.file(home.paths.relativeFile(forId: "innate.gone"))
    ...
    func updateLeavesAuthoredNotesAlone() throws {
        ...
        let beneath = brain.file(home.paths.relativeFile(forId: "\(seed.id).mine"))
    ...
    func plantRestatesSeedRegardlessOfLocked() throws {
        ...
        let seed = try firstSeed()
        let file = home.paths.file(forId: seed.id)
    ...
    private func seedFile(_ id: String) -> URL {
        source.file("document/\(home.paths.relativeFile(forId: id))")
    }
