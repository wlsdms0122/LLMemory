...
struct TemplateTests {
    ...
    func documentWithTemplateScaffoldsFullFrame() throws {
        ...
        let created = OperationsEngine.apply(home.storage, ["ops": [[
    ...
    func patchWithinFrameSucceeds() throws {
        ...
        _ = OperationsEngine.apply(home.storage, ["ops": [[
    ...
    func queryTemplateReturnsFrameSchema() throws {
        ...
        let (note, frame, _) = try home.database().read { db in try home.services.notes.template(GRDBReadScope(db), id: "tpl-spec", sessionId: nil) }
