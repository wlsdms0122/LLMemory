...
struct StructuralLossInvariantTests {
    ...
    private var trash: Trash { Trash(layout: home.layout) }
    ...
    func trashCollisionWriteMatchesTouchesDestination() throws {
        ...
        // When
        let source = try home.read { database in try FetchNotePathTransaction(nid: "trsh-snap").perform(database, home.brain) }
    ...
    func mergeFileRemovalFailureRollsBackAtomically() throws {
        ...
        let fromPath = home.layout.file(forId: "zomb-from")
    ...
    func splitFileRemovalFailureRollsBackAtomically() throws {
        ...
        let sourcePath = home.layout.file(forId: "zomb-ssrc")
