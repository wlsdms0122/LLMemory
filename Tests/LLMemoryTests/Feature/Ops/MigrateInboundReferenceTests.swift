...
struct MigrateInboundReferenceTests {
    ...
    func migrateRewritesInboundCitations() throws {
        ...
        let body = try String(
            contentsOf: home.url.appendingPathComponent(home.path.relativeFile(forId: "referrer")),
            encoding: .utf8
        )
    ...
    func rolledBackMigrateRestoresCitingFiles() throws {
        ...
        let citer = home.url.appendingPathComponent(home.path.relativeFile(forId: "roll-citer"))
    ...
    func migrateWithoutCitationsTouchesNothingElse() throws {
        ...
        let bystander = home.url.appendingPathComponent(home.path.relativeFile(forId: "bystander"))
