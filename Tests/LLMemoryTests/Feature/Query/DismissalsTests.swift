...
struct DismissalsTests {
    ...
    func dismissalIsStimulusSpecific() throws {
        ...
        // Then
        let hits = try home.read { database in try Search.fts(database, query: "zephyrquark") }
    ...
    @discardableResult
    private func createTagged(_ id: String, tags: [String]) -> Transaction.Result {
        home.createNote(
            id: id,
            axis: "tech",
            tags: ["tech"] + tags,
    ...
    @discardableResult
    private func dismiss(_ id: String, kind: String = "split") -> Transaction.Result {
        home.apply(["op": "dismiss_candidate", "id": id, "kind": kind])
    }
    
    @discardableResult
    private func append(to id: String, section: String, words: Int) -> Transaction.Result {
        home.apply([
